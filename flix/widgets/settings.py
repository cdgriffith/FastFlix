...
class Settings(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.svt_av1_select.setFixedHeight(80)
        ...
        self.svt_av1_file_path.setFixedHeight(30)
        ...
        self.open_svt_av1_file.setFixedHeight(30)
        saf_label = QtWidgets.QLabel("Executable:")
        saf_label.setFixedHeight(30)
        svt_av1_file_layout.addWidget(saf_label)
